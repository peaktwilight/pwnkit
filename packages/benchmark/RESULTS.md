...
10 custom challenges covering AI-specific attack surfaces. Flag-based verification.
...
Run: `pnpm bench --agentic`

---

## XBOW Traditional Web Vulnerability Benchmark

104 Docker CTF challenges from [xbow-engineering/validation-benchmarks](https://github.com/xbow-engineering/validation-benchmarks). Each hides a FLAG{...} behind a real web vulnerability.
...
| **pwnkit** | **49% of ran (~22/45)** | Shell-first, open-source, Azure gpt-5.4 |
...
Run: `pnpm --filter @pwnkit/benchmark xbow --agentic`
