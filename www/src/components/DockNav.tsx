  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Docs link */}
        <a
          href="/blog/why-i-built-nightfang"
          className="flex items-center h-9 rounded-xl px-2.5 text-[11px] font-medium text-white/35 hover:text-white/70 transition-colors"
        >
          Blog
        </a>
        ...
        >
          <span className="text-white">{GITHUB_ICON}</span>
