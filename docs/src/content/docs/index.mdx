...
template: splash
hero:
  tagline: General-purpose autonomous pentesting framework. Scans LLM endpoints, web apps, npm packages, and source code. Agentic pipeline -- discover, attack, verify, report. Blind verification kills false positives.
  actions:
    - text: Get Started
